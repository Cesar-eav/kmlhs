<template>
    <nav aria-label="secondary" :class="[
        'sticky inset-x-0 top-0 z-10 px-6 py-4 bg-white flex items-center justify-between transition-transform duration-500 dark:bg-dark-eval-1',
        {
        ...
        <div class="flex items-center gap-2">
            <SearchIcon aria-hidden="true" class="w-10 h-5 text-gray-500" />
